...
public class GraphBuildingHandler extends DefaultHandler {
     ...
     */
    public class PairLongs {
        public long left;
        public long right;

        public PairLongs(long l, long r) {
            left = l;
            right = r;
        }
    ...
    private LinkedList<PairLongs> possibleConnections;
...
//            System.out.println("Beginning a way...");
            possibleConnections = new LinkedList<>();
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            if (lastNodeID != 0) {
                possibleConnections.add(new PairLongs(lastNodeID,
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            g.getNodeMap().get(lastNodeID).setName(attributes.getValue("v"));
        }
    }
...
//            System.out.println("Fiishing a way...");
            if (currentFlag) {
                g.addWay(possibleConnections);
            }
            currentFlag = false;
        }
    }
